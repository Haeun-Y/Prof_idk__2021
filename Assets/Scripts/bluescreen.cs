...
{
    public GameObject circle1, circle2, circle3, circle4, circle5;
    ...
    public void not_on()
    {
        if (circle1.gameObject.activeSelf == true & circle2.gameObject.activeSelf == true & circle3.gameObject.activeSelf == true & circle4.gameObject.activeSelf == true & circle5.gameObject.activeSelf == true)
        {
